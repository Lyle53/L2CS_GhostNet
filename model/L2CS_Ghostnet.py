...
def conv3x3(in_planes, out_planes, stride=1, s=2, d=3):
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, s=2, d=3):
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_bins,s=2, d=3):
        self.inplanes = 64
    ...
    def _make_layer(self, block, planes, blocks, stride=1, s=2, d=3):
        downsample = None
...
if __name__ == '__main__':
    model = ResNet(Bottleneck, [3, 4, 6, 3], 90,s=2, d=3)  # 初始化您的模型
