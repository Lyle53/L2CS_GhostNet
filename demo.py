...
def parse_args():
    ...
    parser.add_argument(
        ...
        #L2CS+GhostNet的權重 output/snapshots/L2CS-gaze360-_1715138455/_epoch_27.pkl
        #L2CS的權重 output\snapshots\L2CS-gaze360-_original\L2CSNet_gaze360.pkl
        default='output\snapshots\L2CS-gaze360-_original\L2CSNet_gaze360.pkl', type=str)
    parser.add_argument(
