...
def parse_args():
    ...
    parser.add_argument(
        ...
        default='datasets/gaze360_RGB/Image', type=str)
    parser.add_argument(
        '--gaze360label_dir', dest='gaze360label_dir', help='Directory path for gaze labels.',
        default='datasets/gaze360_RGB/Label/test.label', type=str)
    ...
    parser.add_argument(
        ...
        default='output/snapshots/L2CS-gaze360-_1718374605', type=str)
    parser.add_argument(
        '--evalpath', dest='evalpath', help='path for the output evaluating gaze test.',
        default="evaluation/L2CS-gaze360-_1718374605", type=str)
    parser.add_argument(
...
if __name__ == '__main__':
    ...
    if data_set=="gaze360":
        ...
        with open(os.path.join(evalpath,data_set+".log"), 'w') as outfile:
            configuration = f"\ntest configuration = gpu_id={gpu}, batch_size={batch_size}, model_arch=MobileOne\nStart testing dataset={data_set}----------------------------------------\n"
            print(configuration)
